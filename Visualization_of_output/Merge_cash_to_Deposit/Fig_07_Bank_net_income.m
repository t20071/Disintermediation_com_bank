...
filename = 'Com_FL_BA_ni_Flows_Bank_NetIncome.xlsx';
...
% Enhanced formatting
ylabel('INR Billion', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'k');
xlabel('CBDC rate as percent of policy rate', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'k');
title('Bank Net Income', 'FontSize', 22, 'FontWeight', 'bold', 'Color', 'k');
