...
filename = 'Com_FL_CB_seign_Flows_CentralBank_SeigniorageDistribution.xlsx';
data = readtable(filename);

% Extract columns
steps = data.Step;
cash = data.Cash;  % Convert to percent
deposit = data.Deposit ;  % Convert to percent
...
% Enhanced formatting
ylabel('INR Billion, Per Annum', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'k');
xlabel('CBDC rate as percent of policy rate', 'FontSize', 14, 'FontWeight', 'bold', 'Color', 'k');
title('Central Bank Net Income', 'FontSize', 22, 'FontWeight', 'bold', 'Color', 'k');
