...
filename = 'Com_avrate_AverageDepositRate_deposit.xlsx';
data = readtable(filename);

% Extract columns
steps = data.Step;
cash = data.Cash * 100;  % Convert to percent
deposit = data.Deposit * 100;  % Convert to percent
...
xlabel('CBDC rate as percent of policy rate', 'FontSize', 12, 'Color', 'k');
title('Aggregate Deposit Rate', 'FontSize', 34, 'FontWeight', 'bold', 'Color', 'k');
