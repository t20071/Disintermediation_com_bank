...
namerun = 'Run_5_deposit_like_nest0_alphacash3_alphaCBDC0_B15';
...
nest_ = [0 0 0 0 0 0]; % nested (1) or non-nested (0) conditional logit model for non-banks' choice of money --- for each counterfactual window
alphas_ = [3.0 -100;3.0 0.0;3.0 0.0;3.0 0.0;3.0 0.0;3.0 0.0]; % base utility for cash and CBDC (in columns) --- for each counterfactual window (in rows)
